...
---
![evolution-path](evolution-path.png)
...
- **Rebuild Demo App Image**
  ...
  Now comment out or remove the old database connection setting in **application.properties**
  ``` properties
  #spring.datasource.url= jdbc:postgresql://${POSTGRES_PORT_5432_TCP_ADDR}:${POSTGRES_PORT_5432_TCP_PORT}/<your_db>
  #spring.datasource.username=<your_user>
  #spring.datasource.password=<your_pwd>
...
- **Deploy Demo App as Docker Container onto Cloud Foundry**
  ...
  - Goto the directory of the manifest file, run command:
    ...
    Note: if you're using your own registry other than DockerHub, please use  
    `sudo cf push --docker-image MY-PRIVATE-REGISTRY.DOMAIN:PORT/REPO/IMAGE:TAG`  
...
#### **TODO - Share Stored Data Between Containers on Cloud Foundry**
  ...
  [6]: https://github.wdf.sap.corp/i075908/spring-boot-webapp-demo/tree/standalone-docker
  [7]: https://github.wdf.sap.corp/i075908/spring-boot-webapp-demo/tree/cf-docker
